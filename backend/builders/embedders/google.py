"""
GoogleEmbedderBuilder — Google Gemini Embedding 模型 Builder
"""
    ...
    field_meta = {
        **BaseEmbedderBuilder.field_meta,
        "model_id": {
            ...
            "group": "基础配置",
            "span": 12,
            "placeholder": "如 models/text-embedding-004",
        },
        "base_url": {
            "label": "Base URL",
            "group": "认证",
