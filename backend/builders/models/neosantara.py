"""
NeosantaraModelBuilder — Neosantara 模型 Builder
"""
...
class NeosantaraModelBuilder(BaseModelBuilder):
    type = "neosantara"
    label = "Neosantara"
    ...
    field_meta = {
        **BaseModelBuilder.field_meta,
        "model_id": {
            ...
            "group": "基础配置",
            "span": 12,
            "placeholder": "如 grok-4.1-fast-non-reasoning",
        },
        "base_url": {
            "label": "Base URL",
            "group": "认证",
            "span": 24,
            "placeholder": "https://api.neosantara.xyz/v1",
        },
        "temperature": {
            "label": "温度",
            "group": "生成参数",
    ...
    def build(self, config: dict, resolver) -> Any:
        ...
        return Neosantara(
            ...
            base_url=config.get("base_url") or "https://api.neosantara.xyz/v1",
