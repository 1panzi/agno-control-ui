"""
SambaNovaModelBuilder — SambaNova 模型 Builder
"""
...
class SambaNovaModelBuilder(BaseModelBuilder):
    type = "sambanova"
    label = "SambaNova"
    ...
    field_meta = {
        **BaseModelBuilder.field_meta,
        "model_id": {
            ...
            "group": "基础配置",
            "span": 12,
            "placeholder": "如 Meta-Llama-3.1-8B-Instruct",
        },
        "base_url": {
            "label": "Base URL",
            "group": "认证",
    ...
    def build(self, config: dict, resolver) -> Any:
        ...
        return Sambanova(
            ...
            base_url=config.get("base_url") or "https://api.sambanova.ai/v1",
