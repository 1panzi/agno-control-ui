"""
AIMLAPIModelBuilder — AIMLAPI 模型 Builder
"""
...
class AIMLAPIModelBuilder(BaseModelBuilder):
    type = "aimlapi"
    label = "AIMLAPI"
    ...
    extra_fields = [
        *BaseModelBuilder.extra_fields,
        ...
        {"name": "max_tokens", "type": "int", "required": False, "default": 4096, "order": 11},
    ]
    field_meta = {
    ...
    def build(self, config: dict, resolver) -> Any:
        ...
        return AIMLAPI(
            ...
            base_url=config.get("base_url") or "https://api.aimlapi.com/v1",
