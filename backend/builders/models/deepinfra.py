"""
DeepInfraModelBuilder — DeepInfra 模型 Builder
"""
...
class DeepInfraModelBuilder(BaseModelBuilder):
    type = "deepinfra"
    label = "DeepInfra"
    ...
    field_meta = {
        **BaseModelBuilder.field_meta,
        "model_id": {
            ...
            "group": "基础配置",
            "span": 12,
            "placeholder": "如 meta-llama/Llama-2-70b-chat-hf",
        },
        "base_url": {
            "label": "Base URL",
            "group": "认证",
    ...
    def build(self, config: dict, resolver) -> Any:
        ...
        return DeepInfra(
            ...
            base_url=config.get("base_url") or "https://api.deepinfra.com/v1/openai",
