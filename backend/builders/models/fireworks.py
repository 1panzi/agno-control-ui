"""
FireworksModelBuilder — Fireworks AI 模型 Builder
"""
...
class FireworksModelBuilder(BaseModelBuilder):
    type = "fireworks"
    label = "Fireworks"
    ...
    field_meta = {
        **BaseModelBuilder.field_meta,
        "model_id": {
            ...
            "group": "基础配置",
            "span": 12,
            "placeholder": "如 accounts/fireworks/models/llama-v3p1-70b-instruct",
        },
        "base_url": {
            "label": "Base URL",
            "group": "认证",
    ...
    def build(self, config: dict, resolver) -> Any:
        ...
        return Fireworks(
            ...
            base_url=config.get("base_url") or "https://api.fireworks.ai/inference/v1",
