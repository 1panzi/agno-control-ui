"""
RequestyModelBuilder — Requesty 模型 Builder
"""
...
class RequestyModelBuilder(BaseModelBuilder):
    type = "requesty"
    label = "Requesty"
    ...
    def build(self, config: dict, resolver) -> Any:
        ...
        return Requesty(
            ...
            base_url=config.get("base_url") or "https://router.requesty.ai/v1",
