"""
N1NModelBuilder — N1N 模型 Builder
"""
...
class N1NModelBuilder(BaseModelBuilder):
    type = "n1n"
    label = "N1N"
    ...
    def build(self, config: dict, resolver) -> Any:
        ...
        return N1N(
            ...
            base_url=config.get("base_url") or "https://api.n1n.ai/v1",
