<template>
  <div class="app-container">
    ...
    <el-dialog v-model="detailVisible" title="Team 详情" width="700px" top="5vh">
...
import { AgnoTeamAPI } from "@/api/agno/team";
...
async function loadData() {
  loading.value = true;
  try {
    const res = await AgnoTeamAPI.listTeams();
